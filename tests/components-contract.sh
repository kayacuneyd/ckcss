...
for selector in ck-button ck-card ck-badge ck-alert ck-field ck-input ck-select ck-textarea ck-table ck-table-wrap ck-disclosure ck-skeleton ck-breadcrumb ck-tabs ck-pagination ck-stepper ck-timeline ck-avatar ck-progress; do
