...
grep -q 'https://cdn.jsdelivr.net/gh/kayacuneyd/ckcss@v0.1.0-beta.1/dist/ckcss.min.css' "$project_dir/site/ckcss-manifest.json"
grep -q 'Use documented `ck-` classes' "$project_dir/site/llms.txt"
